...
(function($) {
  ...
  defaults = {
    ...
    inputs: {
      ...
      paginationPrev: dynatable_txt.prev,
      paginationNext: dynatable_txt.next,
      paginationGap: [1,2,2,1],
      searchTarget: null,
      searchPlacement: 'before',
      searchText: dynatable_txt.search,
      perPageTarget: null,
      perPagePlacement: 'before',
      perPageText: dynatable_txt.show,
      pageText: dynatable_txt.pages,
      recordCountPageBoundTemplate: dynatable_txt.pagebounds,
      recordCountPageUnboundedTemplate: dynatable_txt.recordsshown,
      recordCountTotalTemplate: '{recordsQueryCount} {collectionName}',
      recordCountFilteredTemplate: dynatable_txt.filtered,
      recordCountText: dynatable_txt.showing,
      recordCountTextTemplate: '{text} {pageTemplate} {totalTemplate} {filteredTemplate}',
      recordCountTemplate: '<span id="dynatable-record-count-{elementId}" class="dynatable-record-count">{textTemplate}</span>',
      processingText: dynatable_txt.process
    },
    dataset: {
      ajax: false,
      ajaxUrl: null,
